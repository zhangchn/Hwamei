...
//                _ = context.move(to: CGPoint(x:r0 * cos(a1), y:r0 * sin(a1)))
            ...
            if !(da1 > epsilon) { _ = context.move(to: CGPoint(x: x01, y: y01)) }
                ...
                // Otherwise, draw the two corners and the ring.
                    ...
                    _ = context.arc(center: CGPoint(x: t0.0, y: t0.1), radius: rc1, start: atan2(t0.3, t0.2), end: atan2(t1.5, t1.4), anticlockwise: !cw)
            ...
            if !(r0 > epsilon) || !(da0 > epsilon) {
                ...
                // Otherwise, draw the two corners and the ring.
                    ...
                    _ = context.arc(center: .zero, radius: r0, start:atan2(t0.1 + t0.5, t0.0 + t0.4), end:atan2(t1.0 + t1.5, t1.1 + t1.4), anticlockwise: !cw)
